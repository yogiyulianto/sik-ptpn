...
class Model_batih extends CI_model{
    ...
    {
		$query = $this->db->get_where("batih", $where);
        if($query){
            return $query->row();
        }else{
            return false;
	...
	public function simpan($data)
    {
        ...
        $query = $this->db->insert("batih", $data);
    ...
    {
        $query = $this->db->update("batih", $data, array('batih_id' => $id));
