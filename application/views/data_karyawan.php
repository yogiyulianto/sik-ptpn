		...
		<div class="table-responsive">
			<table id="table" class="table table-striped table-bordered table-hover">
                ...
                ?>
					...
					<tr>
						<td><?php echo $no++ ?></td>
						<td><?php echo $hasil->karyawan_id ?></td>
						<td><?php echo $hasil->karyawan_nama ?></td>
						<td><?php echo $hasil->karyawan_kontak ?></td>
						<td><?php echo $hasil->karyawan_alamat ?></td>
						<td>
							<a href="<?php echo base_url() ?>karyawan/edit/<?php echo $hasil->karyawan_id ?>"
								class="btn btn-sm btn-success">Edit</a>
							<a href="<?php echo base_url() ?>karyawan/hapus/<?php echo $hasil->karyawan_id ?>"
			...
			<a href="<?php echo base_url() ?>karyawan/tambah/" class="btn btn-md btn-success">Tambah Karyawan</a>
		</div>
