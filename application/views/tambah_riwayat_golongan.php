...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div class="container" style="margin-top: 80px">
		<div class="col-md-12">
			<?php echo form_open('riwayatgolongan/simpan') ?>
			...
			<table id="table" class="table table-striped table-bordered table-hover">
                ...
                ?>
					...
					<tr>
						...
						<td>
							<a href="<?php echo base_url() ?>riwayatgolongan/edit/<?php echo $hasil['riwayat_golongan_id'] ?>"
								class="btn btn-sm btn-success">Edit</a>
							<a href="<?php echo base_url() ?>riwayatgolongan/hapus/<?php echo $hasil['riwayat_golongan_id'] ?>"
