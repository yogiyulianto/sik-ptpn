...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div class="container" style="margin-top: 80px">
		<div class="col-md-12">
			<?php echo form_open('rewards/update') ?>
			<input type="hidden" name="rewards_id" value="<?php echo $detail->rewards_id ?>" class="form-control">
			...
			<div class="form-group">
				...
				<select class="form-control" name="kategori">
					<option <?php 
					if($detail->kategori == 'Rewards')
					{
						echo "selected = 'selected'"; 
					}?> >Rewards</option>
					<option <?php 
					if($detail->kategori == 'Punisment')
					{
						echo "selected = 'selected'"; 
					}?> >Punisment</option>
				</select>
			...
			<div class="form-group">
				...
				<select class="form-control" name="keterangan">
					<option <?php 
					if($detail->keterangan == 'Penghargaan')
					{
						echo "selected = 'selected'"; 
					}?> >Penghargaan</option>
					<option <?php 
					if($detail->keterangan == 'Prestasi')
					{
						echo "selected = 'selected'"; 
					}?> >Prestasi</option>
				</select>
			...
			<div class="form-group">
				...
				<input type="text" name="perihal" value="<?php echo $detail->perihal ?>" class="form-control">
			</div>

			<div class="form-group">
				<label for="text">Nomor Surat</label>
				<input type="text" name="nomor_surat" value="<?php echo $detail->nomor_surat ?>" class="form-control">
			</div>
