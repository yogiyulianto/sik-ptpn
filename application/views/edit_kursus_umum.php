...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div class="container" style="margin-top: 80px">
		<div class="col-md-12">
			<?php echo form_open('kursusumum/update') ?>
			<input type="hidden" name="kursus_umum_id" value="<?php echo $detail->kursus_umum_id ?>" class="form-control">
			...
			<div class="form-group">
				...
				<input type="text" name="nama_kursus" value="<?php echo $detail->nama_kursus ?>" class="form-control">
			</div>

			<div class="form-group">
				<label for="text">Penyelenggara</label>
				<input type="text" name="penyelenggara" value="<?php echo $detail->penyelenggara ?>" class="form-control">
			</div>
